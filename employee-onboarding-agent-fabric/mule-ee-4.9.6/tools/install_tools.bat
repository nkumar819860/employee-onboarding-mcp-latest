...
IF EXIST "%BASE_DIR%\bin\support-tools-installer-4.9.6-final.jar" move "%BASE_DIR%\bin\support-tools-installer-4.9.6-final.jar" "%BASE_DIR%\tools"
java -jar "%BASE_DIR%\tools\support-tools-installer-4.9.6-final.jar" %*
