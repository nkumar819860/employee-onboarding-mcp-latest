...
echo * If it is already installed, configure the system variables         *
echo * JAVA_HOME or PATH appropriately.                                   *
echo **********************************************************************
...
for %%a in ("%JAVA%") do set "p_dir=%%~dpa"
for %%a in (%p_dir:~0,-1%) do set "JAVA_HOME=%%~dpa"
