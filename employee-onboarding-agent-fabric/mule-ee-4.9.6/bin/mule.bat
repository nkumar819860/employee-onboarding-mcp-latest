...
rem
rem Default is 32 bits
set _WRAPPER_L_EXE=%_WRAPPER_BASE%-windows-x86-32.exe
goto search
:amd64
set _WRAPPER_L_EXE=%_WRAPPER_BASE%-windows-x86-64.exe
goto search
:ia64
set _WRAPPER_L_EXE=%_WRAPPER_BASE%-windows-ia-64.exe
goto search
:search
...
rem Remove trailing slash ("\") from the CD variable path to avoid this slash to escape the next character ("SE-8871")
set _WRAPPER_WORKING_DIR=%CD%
if "%CD:~-1%"=="\" set _WRAPPER_WORKING_DIR=%CD:~0,-1%
...
set MULE_OPTS=set.MULE_APP=%MULE_APP% set.MULE_APP_LONG=%MULE_APP_LONG% set.MULE_HOME="%MULE_HOME%" set.MULE_BASE="%MULE_BASE%" set.MULE_LIB=%MULE_LIB% set.JAVA_HOME="%JAVA_HOME%" wrapper.working.dir="%_WRAPPER_WORKING_DIR%" wrapper.app.parameter.1=%1 wrapper.app.parameter.2=%2  wrapper.app.parameter.3=%3  wrapper.app.parameter.4=%4  wrapper.app.parameter.5=%5  wrapper.app.parameter.6=%6  wrapper.app.parameter.7=%7  wrapper.app.parameter.8=%8 wrapper.app.parameter.9=%9
